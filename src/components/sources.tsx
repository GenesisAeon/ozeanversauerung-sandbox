const CITES = [
  {
    ...
    note: "Grenze ueberschritten: ~40 % Oberflaeche / ~60 % Unterwasser bis 200 m; Beginn ~2020. Kein Kipppunkt.",
  },
  {
    ...
    note: "80-%-Schwellwert erfuellt eigene Kriterien nicht; Arktis heute untersaettigt; Korallen braeuchten 85 %.",
  },
];
  ...
  return (
    <section className="rounded-xl bg-surface p-4 shadow-border sm:p-5">
      ...
      <p className="mt-2 max-w-3xl text-sm leading-relaxed text-muted">
        Konstanten 1:1 aus ocean-acidification-utac (P122). Die Oberflaeche ist Deutsch;
        Zahlen und Zitationen bleiben in ihren Einheiten.
      </p>
      ...
      <p className="mt-5 text-xs leading-relaxed text-subtle">
        Keine UTAC/CREP/AFET-Verknuepfung. Die Ozeanchemie steht fuer sich. Owner:
        GenesisAeon / Johann Roemer. MIT.
      </p>
    </section>
  );
}
