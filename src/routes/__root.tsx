...
const APP_NAME = "Ozeanversauerung";
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Interaktive Streitkarte fuer Ozeanversauerung (planetare Grenze). Findlay 2025 / Findlay & Feely 2026. Kein Kipppunkt. P122.",
      },
